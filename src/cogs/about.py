...
class About(commands.Cog):
    ...
    async def about(self, ctx):
        embed=discord.Embed(title="About", url="https://dinoosawruss.github.io/NameBot-Site/", description=f"The results {ctx.author}'s lookup", color=options.getEmbedColour(ctx.guild.id))
